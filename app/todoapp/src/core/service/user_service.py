...
from app.src.infra.repository.user_repository import UserRepository, get_db

# Şifreleme işlemleri için bcrypt kullanıyoruz
pwd_context = CryptContext(schemes=["bcrypt"], deprecated="auto")


def create_access_token(data: dict) -> str:
    """
    Token oluşturma işlemini gerçekleştiren fonksiyon.
    Bu fonksiyon, JWT kütüphanesi veya benzeri bir yapı kullanılarak implement edilebilir.
    """
    import jwt
