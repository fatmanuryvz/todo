...
import redis
import json
from app.src.core.models.todo import TodoCreate, TodoResponse
from app.src.core.service.todo_service import TodoService
from app.src.core.service.user_service import UserService  # Doğrulama için dependency
from app.src.infra.repository.entities.user_entity import User
from urllib.parse import urlparse
from app.src.infra.config.app_config import REDIS_HOST
